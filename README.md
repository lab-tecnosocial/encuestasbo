...
# ECE armonizada entre trimestres (apila versiones del cuestionario, con `anio`/`trimestre`)
...
Para comparar ingresos entre años sin el sesgo de la inflación,
`deflactar()` lleva valores nominales a precios constantes de un año
base con el IPC de Bolivia (media anual; dataset `ipc_bolivia`).
